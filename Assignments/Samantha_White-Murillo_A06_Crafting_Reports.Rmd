...
```{r Ozone 2018, echo=FALSE, fig.cap= "Ozone levels in 2018", fig.align='center', warning=FALSE, out.width='65%'}

ggplot(EPA_ozone_2018, aes(x = Month, y = Ozone)) +
  geom_boxplot() +
...
```{r Ozone 2019, echo=FALSE, fig.cap= "Ozone levels in 2019", fig.align='center', warning=FALSE, out.width='65%'}

ggplot(EPA_ozone_2019, aes(x = Month, y = Ozone)) +
  geom_boxplot() +
 labs(y = "Concentration (µg/m3)")
