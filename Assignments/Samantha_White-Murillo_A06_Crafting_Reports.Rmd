...
1.  Rename this file `Samantha_White-Murillo_A06_CraftingReports.Rmd` (replacing `<FirstLast>` with your first and last name).
...
```{r Ozone 2018, echo=FALSE, fig.align='center', fig.cap="Ozone levels in 2018", warning=FALSE, out.width='65%'}

ggplot(EPA_ozone_2018, aes(x = as.factor(Month), y = Ozone)) +
  geom_boxplot() +
  labs(y = "Concentration (µg/m3)")
...
```{r Ozone 2019, echo=FALSE, fig.align='center', fig.cap="Ozone levels in 2019", warning=FALSE, out.width='65%'}

ggplot(EPA_ozone_2019, aes(x = as.factor(Month), y = Ozone)) +
  geom_boxplot() +
 labs(y = "Concentration (µg/m3)")
...
https://github.com/SamanthaWM/EDA_Spring2024_SamanthaWM
