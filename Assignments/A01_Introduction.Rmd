...
## Directions
1.  Rename this file `<SamanthaWhite-Murillo>_A01_Introduction.Rmd` (replacing `<FirstLast>` with your first and last name).
...
> Answer: I don't have experience with R nor git, but I'm agile learning to use these programs.

2. Are there any components of the course about which you feel confident?

> Answer: General data analisys is easyly understendable for me

3. Are there any components of the course about which you feel apprehensive?

> Answer: Maybe to be left behind in comparison with my classmates that already have experience with the progrmas.
