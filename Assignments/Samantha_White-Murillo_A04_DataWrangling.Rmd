...
#4
EPAair_O3_NC2018 <- select(EPAair_O3_NC2018_raw, 
                           Date, 
                           DAILY_AQI_VALUE, 
                           Site.Name, 
                           AQS_PARAMETER_DESC, 
...
EPAair_O3_NC2019 <- select(EPAair_O3_NC2019_raw, 
...
EPAair_PM25_NC2018 <- select(EPAair_PM25_NC2018_raw, 
                             Date, DAILY_AQI_VALUE, 
                             Site.Name, 
                             AQS_PARAMETER_DESC, 
                             COUNTY, SITE_LATITUDE, 
...
EPAair_PM25_NC2019 <- select(EPAair_PM25_NC2019_raw, 
                             Date, DAILY_AQI_VALUE, 
                             Site.Name, 
                             AQS_PARAMETER_DESC, 
                             COUNTY, 
...
#11
write.csv(EPAair_combined_data, row.names = FALSE, 
