...
#12
GaringerOzone.trend <- 
  Kendall::MannKendall(GaringerOzone.monthly.ts)
...
GaringerOzone.monthly.ts.component <- mutate(GaringerOzone.monthly.ts.component,
