...
#assignment 5 note
  ...
  geom_hline(yintercept = 15, lty = 3) +
  geom_hline(yintercept = 30, lty = 3) +
  geom_vline(xintercept = 5, lty = 3, color = "lightblue") +
  geom_vline(xintercept = 10, lty = 3, color = "lightblue") +
  geom_vline(xintercept = 15, lty = 3, color = "lightblue") +
```
